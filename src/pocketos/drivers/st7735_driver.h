#ifndef POCKETOS_ST7735_DRIVER_H
#define POCKETOS_ST7735_DRIVER_H
...
// ST7735 128x160 TFT LCD Display Driver
// Endpoint format: spi0:cs=5,dc=16,rst=17 (dc and rst required)

class ST7735Driver : public SPIDriverBase {
public:
    ST7735Driver();
    ~ST7735Driver();
    ...
    // Identification probe - reads Display Status (0x09 command)
...
#endif // POCKETOS_ST7735_DRIVER_H

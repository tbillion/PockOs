#ifndef POCKETOS_ST7789_DRIVER_H
#define POCKETOS_ST7789_DRIVER_H
...
// ST7789 240x240/240x320 TFT LCD Display Driver
// Endpoint format: spi0:cs=5,dc=16,rst=17 (dc and rst required)

class ST7789Driver : public SPIDriverBase {
public:
    ST7789Driver();
    ~ST7789Driver();
...
#endif // POCKETOS_ST7789_DRIVER_H
